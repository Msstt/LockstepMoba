...
namespace UI.Actor {
    public struct TurretStatsBarPanelParam : IUIParam {
        public Combat.Actor.Actor actor;
    }
    
    public class TurretStatsBarPanel : UIPanel {
        ...
        public override void OnShow(IUIParam uiParam) {
            if (uiParam is not TurretStatsBarPanelParam param || param.actor == null) {
                return;
            }
            actor = param.actor;
